  ...
  return (
    <main>
      ...
      <section className="flex flex-col items-center min-h-screen text-gray-700 p-12 md:p-24 gap-[24px] bg-slate-50">
        <h1 className="text-[44px] md:text-[56px] font-bold text-gray-700">What we provide?</h1>
        <div>
          ...
          <div className="flex gap-[24px]">
            ...
            <span className="text-[32px] md:text-[44px]">Pay as you go <span className="italic underline decoration-wavy decoration-gray-800">pricing</span> model</span>
          </div>
          <div className="flex gap-[24px]">
            <div className="flex flex-col justify-center items-center">
              <div className="w-[12px] h-[12px] bg-gray-700 rounded-full" />
            ...
            <span className="text-[32px] md:text-[44px]">Real time <span className="italic underline decoration-wavy decoration-gray-800">Analytics</span></span>
          </div>
          <div className="flex gap-[24px]">
            <div className="flex flex-col justify-center items-center">
              <div className="w-[12px] h-[12px] bg-gray-700 rounded-full" />
            ...
            <span className="text-[32px] md:text-[44px]">AI Generated <span className="italic underline decoration-wavy decoration-gray-800">Templates</span></span>
          </div>
          <div className="flex gap-[24px]">
            <div className="flex flex-col justify-center items-center">
              <div className="w-[12px] h-[12px] bg-gray-700 rounded-full" />
            ...
            <span className="text-[32px] md:text-[44px]">Waitlist <span className="italic underline decoration-wavy decoration-gray-800">Forms</span></span>
          </div>
          <div className="flex gap-[24px]">
            <div className="flex flex-col justify-center items-center">
              <div className="w-[12px] h-[12px] bg-gray-700 rounded-full" />
            ...
            <span className="text-[32px] md:text-[44px]">Business <span className="italic underline decoration-wavy decoration-gray-800">API</span></span>
          </div>
          <div className="flex gap-[24px]">
            <div className="flex flex-col justify-center items-center">
              <div className="w-[12px] h-[12px] bg-gray-700 rounded-full" />
